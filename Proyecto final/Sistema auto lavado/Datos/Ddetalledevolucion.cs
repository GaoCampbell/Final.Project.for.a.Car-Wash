...
namespace Datos
{
    public class Ddetalledevolucion
    {
        ...
        public List<Edetalledevolucion> obtenerlistadetalle()
        {
            try
            {
                ...
                List<Edetalledevolucion> listadetalle = new List<Edetalledevolucion>();
                while (leer.Read())
                {
                    Edetalledevolucion nuevaFila = new Edetalledevolucion();
                    if (leer.IsDBNull(0))
